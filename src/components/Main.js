      ...
      <Container>
        <ShareBox>
          ...
          <div>
            ...
            <button>
              <img
                src='https://cdn-icons-png.flaticon.com/512/1636/1636028.png'
                className='post-icon'
                alt=''
              />
              <span>Event</span>
            ...
            <button>
              <img
                src='https://cdn-icons-png.flaticon.com/512/4228/4228952.png'
                className='post-icon'
                alt=''
              />
        ...
        {props.articles.length === 0 ? (
          ...
          <Content>
            {props.loading && <img src='https://c.tenor.com/wpSo-8CrXqUAAAAi/loading-loading-forever.gif' />}
            {props.articles.length != 0 &&
